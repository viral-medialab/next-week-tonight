...
def process_input():
    ...
    AI_generated_questions, relevant_articles, scenarios, out = q2a_workflow(article, query, 6)
    if len(sys.argv) == 4:
        out_file = sys.argv[3]
...
#example CL prompt: 
    ...
    /Users/allenbaranov/opt/anaconda3/envs/news/bin/python Backendv2/query_CLI.py https://www.msn.com/en-us/news/politics/trump-is-clearly-annoyed-by-nikki-haley-s-decision-to-stay-in-the-presidential-race/ar-BB1hc4Nf "What happens if Trump wins the general election?"
